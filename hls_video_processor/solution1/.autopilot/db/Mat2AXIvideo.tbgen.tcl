...
set C_modelArgList {
	...
	{ AXI_video_strm_V_data_V int 24 regular {axi_s 1 volatile  { stream_out Data } }  }
	{ AXI_video_strm_V_keep_V int 3 regular {axi_s 1 volatile  { stream_out Keep } }  }
	{ AXI_video_strm_V_strb_V int 3 regular {axi_s 1 volatile  { stream_out Strb } }  }
	{ AXI_video_strm_V_user_V int 1 regular {axi_s 1 volatile  { stream_out User } }  }
	{ AXI_video_strm_V_last_V int 1 regular {axi_s 1 volatile  { stream_out Last } }  }
	{ AXI_video_strm_V_id_V int 1 regular {axi_s 1 volatile  { stream_out ID } }  }
	{ AXI_video_strm_V_dest_V int 1 regular {axi_s 1 volatile  { stream_out Dest } }  }
}
...
set portList { 
	...
	{ stream_out_TDATA sc_out sc_lv 24 signal 3 } 
	{ stream_out_TVALID sc_out sc_logic 1 outvld 9 } 
	{ stream_out_TREADY sc_in sc_logic 1 outacc 3 } 
	{ stream_out_TKEEP sc_out sc_lv 3 signal 4 } 
	{ stream_out_TSTRB sc_out sc_lv 3 signal 5 } 
	{ stream_out_TUSER sc_out sc_lv 1 signal 6 } 
	{ stream_out_TLAST sc_out sc_lv 1 signal 7 } 
	{ stream_out_TID sc_out sc_lv 1 signal 8 } 
	{ stream_out_TDEST sc_out sc_lv 1 signal 9 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "stream_out_TDATA", "direction": "out", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "AXI_video_strm_V_data_V", "role": "default" }} , 
 	{ "name": "stream_out_TVALID", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "AXI_video_strm_V_dest_V", "role": "default" }} , 
 	{ "name": "stream_out_TREADY", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "outacc", "bundle":{"name": "AXI_video_strm_V_data_V", "role": "default" }} , 
 	{ "name": "stream_out_TKEEP", "direction": "out", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "AXI_video_strm_V_keep_V", "role": "default" }} , 
 	{ "name": "stream_out_TSTRB", "direction": "out", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "AXI_video_strm_V_strb_V", "role": "default" }} , 
 	{ "name": "stream_out_TUSER", "direction": "out", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "AXI_video_strm_V_user_V", "role": "default" }} , 
 	{ "name": "stream_out_TLAST", "direction": "out", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "AXI_video_strm_V_last_V", "role": "default" }} , 
 	{ "name": "stream_out_TID", "direction": "out", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "AXI_video_strm_V_id_V", "role": "default" }} , 
 	{ "name": "stream_out_TDEST", "direction": "out", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "AXI_video_strm_V_dest_V", "role": "default" }}  ]}
...
set Spec2ImplPortList { 
	...
	AXI_video_strm_V_data_V { axis {  { stream_out_TDATA out_data 1 24 }  { stream_out_TREADY out_acc 0 1 } } }
	AXI_video_strm_V_keep_V { axis {  { stream_out_TKEEP out_data 1 3 } } }
	AXI_video_strm_V_strb_V { axis {  { stream_out_TSTRB out_data 1 3 } } }
	AXI_video_strm_V_user_V { axis {  { stream_out_TUSER out_data 1 1 } } }
	AXI_video_strm_V_last_V { axis {  { stream_out_TLAST out_data 1 1 } } }
	AXI_video_strm_V_id_V { axis {  { stream_out_TID out_data 1 1 } } }
	AXI_video_strm_V_dest_V { axis {  { stream_out_TVALID out_vld 1 1 }  { stream_out_TDEST out_data 1 1 } } }
}
